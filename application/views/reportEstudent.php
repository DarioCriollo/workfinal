                                ...
                                <?php if (!empty($datos)): ?>
                                    <?php foreach($datos as $venta):?>
                                        <tr>
                                            ...
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivela1.'</b></h7>'."<b>/20</b>";?></td>
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivela2.'</b></h7>'."<b>/20</b>";?></td>
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivela2a.'</b></h7>'."<b>/9</b>";?></td>
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivelb1.'</b></h7>'."<b>/15</b>";?></td>
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivelb1a.'</b></h7>'."<b>/8</b>";?></td>
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivelb2.'</b></h7>'."<b>/10</b>";?></td>
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivelb2a.'</b></h7>'."<b>/2</b>";?></td>
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivelc1.'</b></h7>'."<b>/5</b>";?></td>
                                            <td><?php echo '<h7 style="color:lime"><b>'.$venta->nivelc1a.'</b></h7>'."<b>/2</b>";?></td>
                                            <td><?php echo $venta->final_level;?></td>
